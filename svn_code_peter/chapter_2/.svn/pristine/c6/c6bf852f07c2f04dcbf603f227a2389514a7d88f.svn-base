...
constexpr size_t stack_limit= 1 << 16;
...
int main(int argc, char** argv) 
{
    ...
    using al= lifo_allocator<int, 500>;
    ...
    cout << "block starts at " << &static_memory_block<int, 500>::get_block()[0]
    	 << " and ends at " << &static_memory_block<int, 500>::get_block()[500] << endl;
